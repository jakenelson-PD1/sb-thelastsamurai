...
export function Thermometer02Icon({ size = 20, className, ...props }: Thermometer02IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
<path d="M10 15.4167C10.4603 15.4167 10.8333 15.0436 10.8333 14.5833C10.8333 14.1231 10.4603 13.75 10 13.75C9.53976 13.75 9.16667 14.1231 9.16667 14.5833C9.16667 15.0436 9.53976 15.4167 10 15.4167Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
