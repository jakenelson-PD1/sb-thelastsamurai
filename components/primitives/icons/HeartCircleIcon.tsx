...
export function HeartCircleIcon({ size = 'md', className, ...props }: HeartCircleIconProps) {
...
<path d="M10 18.3333C14.6024 18.3333 18.3334 14.6023 18.3334 9.99996C18.3334 5.39758 14.6024 1.66663 10 1.66663C5.39765 1.66663 1.66669 5.39758 1.66669 9.99996C1.66669 14.6023 5.39765 18.3333 10 18.3333Z" stroke="currentColor" strokeWidth="1.6667" strokeLinecap="round" strokeLinejoin="round"/>
