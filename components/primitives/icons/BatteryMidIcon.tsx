...
export interface BatteryMidIconProps {
  size?: number;
  className?: string;
  'aria-label'?: string;
}

export function BatteryMidIcon({ size = 20, className, ...props }: BatteryMidIconProps) {
  return (
    <svg
      width={size}
      height={size}
