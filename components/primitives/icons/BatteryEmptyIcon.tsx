...
export function BatteryEmptyIcon({ size = 20, className, ...props }: BatteryEmptyIconProps) {
  return (
    <svg
      width={size}
      height={size}
