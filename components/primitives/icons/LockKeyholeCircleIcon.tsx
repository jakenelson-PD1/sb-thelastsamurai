...
export function LockKeyholeCircleIcon({ size = 20, className, ...props }: LockKeyholeCircleIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
<path d="M9.99999 18.3337C14.6023 18.3337 18.3333 14.6027 18.3333 10.0003C18.3333 5.39795 14.6023 1.66699 9.99999 1.66699C5.39761 1.66699 1.66666 5.39795 1.66666 10.0003C1.66666 14.6027 5.39761 18.3337 9.99999 18.3337Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
