...
export interface Trash01IconProps {
  size?: number;
  className?: string;
  'aria-label'?: string;
}

export function Trash01Icon({ size = 20, className, ...props }: Trash01IconProps) {
  return (
    <svg
      width={size}
      height={size}
