...
export interface LockUnlocked01IconProps {
  size?: IconSizeProp;
  className?: string;
  'aria-label'?: string;
}

export function LockUnlocked01Icon({ size = 'md', className, ...props }: LockUnlocked01IconProps) {
