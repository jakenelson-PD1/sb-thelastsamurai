...
export interface CreditCardUpIconProps {
  size?: number;
  className?: string;
  'aria-label'?: string;
}

export function CreditCardUpIcon({ size = 20, className, ...props }: CreditCardUpIconProps) {
  return (
    <svg
      width={size}
      height={size}
