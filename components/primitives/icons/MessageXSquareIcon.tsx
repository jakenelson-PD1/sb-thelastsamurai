...
export interface MessageXSquareIconProps {
  size?: number;
  className?: string;
  'aria-label'?: string;
}

export function MessageXSquareIcon({ size = 20, className, ...props }: MessageXSquareIconProps) {
  return (
    <svg
      width={size}
      height={size}
