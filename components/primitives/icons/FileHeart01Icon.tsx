...
export function FileHeart01Icon({ size = 20, className, ...props }: FileHeart01IconProps) {
  return (
    <svg
      width={size}
      height={size}
