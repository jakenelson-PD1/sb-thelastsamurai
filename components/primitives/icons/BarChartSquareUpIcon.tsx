...
export interface BarChartSquareUpIconProps {
  size?: number;
  className?: string;
  'aria-label'?: string;
}

export function BarChartSquareUpIcon({ size = 20, className, ...props }: BarChartSquareUpIconProps) {
  return (
    <svg
      width={size}
      height={size}
