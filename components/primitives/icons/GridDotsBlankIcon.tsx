...
export interface GridDotsBlankIconProps {
  size?: number;
  className?: string;
  'aria-label'?: string;
}

export function GridDotsBlankIcon({ size = 20, className, ...props }: GridDotsBlankIconProps) {
  return (
    <svg
      width={size}
      height={size}
