...
export function EyeIcon({ size = 20, className, ...props }: EyeIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
<path d="M10.0003 12.5C11.3811 12.5 12.5003 11.3807 12.5003 10C12.5003 8.61925 11.3811 7.5 10.0003 7.5C8.61959 7.5 7.50034 8.61925 7.50034 10C7.50034 11.3807 8.61959 12.5 10.0003 12.5Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
