...
export interface MessagePlusSquareIconProps {
  size?: number;
  className?: string;
  'aria-label'?: string;
}

export function MessagePlusSquareIcon({ size = 20, className, ...props }: MessagePlusSquareIconProps) {
  return (
    <svg
      width={size}
      height={size}
