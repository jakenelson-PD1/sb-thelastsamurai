...
export interface Trash04IconProps {
  size?: number;
  className?: string;
  'aria-label'?: string;
}

export function Trash04Icon({ size = 20, className, ...props }: Trash04IconProps) {
  return (
    <svg
      width={size}
      height={size}
