...
export function CreditCardPlusIcon({ size = 20, className, ...props }: CreditCardPlusIconProps) {
  return (
    <svg
      width={size}
      height={size}
