...
export interface MessageCheckSquareIconProps {
  size?: number;
  className?: string;
  'aria-label'?: string;
}

export function MessageCheckSquareIcon({ size = 20, className, ...props }: MessageCheckSquareIconProps) {
  return (
    <svg
      width={size}
      height={size}
