...
export interface Cube03IconProps {
  size?: IconSizeProp;
  className?: string;
  'aria-label'?: string;
}

export function Cube03Icon({ size = 'md', className, ...props }: Cube03IconProps) {
