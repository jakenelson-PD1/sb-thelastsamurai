...
export function FileDownload01Icon({ size = 20, className, ...props }: FileDownload01IconProps) {
  return (
    <svg
      width={size}
      height={size}
