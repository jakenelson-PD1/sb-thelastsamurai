...
export interface MessageQuestionSquareIconProps {
  size?: IconSizeProp;
  className?: string;
  'aria-label'?: string;
}

export function MessageQuestionSquareIcon({ size = 'md', className, ...props }: MessageQuestionSquareIconProps) {
