...
export function Image04Icon({ size = 'md', className, ...props }: Image04IconProps) {
...
<path d="M7.5 7.91667L5 12.5H15L11.25 6.25L9.16667 9.16667L7.5 7.91667Z" stroke="currentColor" strokeWidth="1.6667" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
