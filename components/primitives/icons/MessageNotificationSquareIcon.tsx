...
export interface MessageNotificationSquareIconProps {
  size?: IconSizeProp;
  className?: string;
  'aria-label'?: string;
}

export function MessageNotificationSquareIcon({ size = 'md', className, ...props }: MessageNotificationSquareIconProps) {
