...
export function User02Icon({ size = 'md', className, ...props }: User02IconProps) {
...
<path d="M10 10C12.0711 10 13.75 8.32107 13.75 6.25C13.75 4.17893 12.0711 2.5 10 2.5C7.92891 2.5 6.24998 4.17893 6.24998 6.25C6.24998 8.32107 7.92891 10 10 10Z" stroke="currentColor" strokeWidth="1.6667" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
