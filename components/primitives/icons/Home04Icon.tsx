...
export function Home04Icon({ size = 20, className, ...props }: Home04IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M10 13.3334C11.3807 13.3334 12.5 12.2141 12.5 10.8334C12.5 9.45264 11.3807 8.33337 10 8.33337C8.61925 8.33337 7.5 9.45264 7.5 10.8334C7.5 12.2141 8.61925 13.3334 10 13.3334Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
