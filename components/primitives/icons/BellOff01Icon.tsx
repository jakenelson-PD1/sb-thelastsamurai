...
export interface BellOff01IconProps {
  size?: number;
  className?: string;
  'aria-label'?: string;
}

export function BellOff01Icon({ size = 20, className, ...props }: BellOff01IconProps) {
  return (
    <svg
      width={size}
      height={size}
