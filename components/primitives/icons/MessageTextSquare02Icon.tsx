...
export interface MessageTextSquare02IconProps {
  size?: IconSizeProp;
  className?: string;
  'aria-label'?: string;
}

export function MessageTextSquare02Icon({ size = 'md', className, ...props }: MessageTextSquare02IconProps) {
