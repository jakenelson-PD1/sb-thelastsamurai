...
export interface LinkExternal01IconProps {
  size?: IconSizeProp;
  className?: string;
  'aria-label'?: string;
}

export function LinkExternal01Icon({ size = 'md', className, ...props }: LinkExternal01IconProps) {
