...
export interface Bell02IconProps {
  size?: number;
  className?: string;
  'aria-label'?: string;
}

export function Bell02Icon({ size = 20, className, ...props }: Bell02IconProps) {
  return (
    <svg
      width={size}
      height={size}
