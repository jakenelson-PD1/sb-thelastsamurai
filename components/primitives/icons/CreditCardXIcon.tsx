...
export interface CreditCardXIconProps {
  size?: number;
  className?: string;
  'aria-label'?: string;
}

export function CreditCardXIcon({ size = 20, className, ...props }: CreditCardXIconProps) {
  return (
    <svg
      width={size}
      height={size}
