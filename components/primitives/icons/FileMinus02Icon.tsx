...
export function FileMinus02Icon({ size = 20, className, ...props }: FileMinus02IconProps) {
  return (
    <svg
      width={size}
      height={size}
