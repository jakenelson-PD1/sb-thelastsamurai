...
const ALL_REQUESTS: RequestDef[] = [
  // ─── General / Planning ──────────────────────────────────────────────────
  { id: 'g1', sectionId: 'general',   order: 1,  title: 'Inquiries',                description: 'Answers to initial engagement questionnaire items from the audit team',                          tileStatus: 'fulfilled',   rowStatus: 'accepted',  attachmentLabel: 'Firm provided 3 files', meta: [{ type: 'due-date', date: '03/15/2025' }, { type: 'documents', count: 12, dot: 'unread' as const }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
  { id: 'g2', sectionId: 'general',   order: 2,  title: 'CEO Initial Inquiries',    description: 'Executive-level responses to audit inquiries directed to the CEO',                               tileStatus: 'outstanding', rowStatus: 'fulfilled', isFlagged: true, attachmentLabel: 'Firm provided 2 files', meta: [{ type: 'e-signature' }, { type: 'due-date', date: '04/18/2025' }, { type: 'comments', count: 2, dot: 'unread' as const }, { type: 'documents', count: 3, dot: 'attention' as const }] },
  { id: 'g3', sectionId: 'general',   order: 3,  title: 'CFO Initial Inquiries',    description: 'Procedures and process documentation regarding IT general controls',                              tileStatus: 'outstanding', rowStatus: 'fulfilled', attachmentLabel: 'Firm provided 8 files', meta: [{ type: 'due-date', date: '04/18/2025' }, { type: 'comments', count: 2, dot: 'unread' as const }] },
  ...
  { id: 'g5', sectionId: 'general',   order: 5,  title: 'Prior Year Audit Report',  description: 'Final signed audit report and management letter from the prior year engagement',                 tileStatus: 'overdue',     rowStatus: 'returned',  attachmentLabel: 'Firm provided 1 file', meta: [{ type: 'due-date', date: '03/28/2025' }, { type: 'comments', count: 1, dot: 'unread' as const }, { type: 'documents', count: 4, dot: 'unread' as const }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
  ...
  // ─── Financial Reporting ─────────────────────────────────────────────────
  { id: 'f1',  sectionId: 'financial', order: 7,  title: 'Legal Expenses',                                 description: 'Detail of all legal fees expensed during the fiscal year by matter',                        tileStatus: 'fulfilled',   rowStatus: 'accepted',  isFlagged: true, meta: [{ type: 'due-date', date: '04/18/2025' }, { type: 'comments', count: 2, dot: 'unread' as const }] },
  ...
  { id: 'f10', sectionId: 'financial', order: 16, title: 'Draft Financial Statements',                     description: 'Complete draft financial statement package provided for auditor review and comment',         tileStatus: 'fulfilled',   rowStatus: 'accepted',  isFlagged: true, attachmentLabel: 'Firm provided 8 files', meta: [{ type: 'due-date', date: '04/18/2025' }, { type: 'comments', count: 2, dot: 'unread' as const }, { type: 'documents', count: 3, dot: 'unread' as const }] },
  ...
  { id: 'c3', sectionId: 'cash',      order: 20, title: 'Bank Reconciliation Statements', description: 'Reconciliation of book cash balances to bank statement balances at period end',          tileStatus: 'overdue',     rowStatus: 'returned',   meta: [{ type: 'due-date', date: '04/15/2025' }, { type: 'comments', count: 2, dot: 'unread' as const }, { type: 'documents', count: 17, dot: 'unread' as const }, { type: 'assignee', initials: 'MK', color: 'var(--color-status-orange-surface)', textColor: 'var(--color-status-orange-fg)' }] },
  ...
  { id: 'a3', sectionId: 'ar',        order: 27, title: 'Customer Contracts',               description: 'Executed contracts for significant customers underlying revenue recognition',         tileStatus: 'overdue',     rowStatus: 'returned',   meta: [{ type: 'due-date', date: '03/25/2025' }, { type: 'comments', count: 3 }, { type: 'documents', count: 5 }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
  ...
  { id: 'i3', sectionId: 'inventory', order: 36, title: 'Inventory Rollforward',           description: 'Reconciliation of beginning to ending inventory balances by product category',        tileStatus: 'fulfilled',   rowStatus: 'accepted',   attachmentLabel: 'Firm provided 3 files', meta: [{ type: 'due-date', date: '04/10/2025' }, { type: 'documents', count: 18 }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
  ...
  { id: 'tx2', sectionId: 'tax',      order: 61, title: 'Deferred Tax Asset / Liability Schedule', description: 'Deferred tax schedule by temporary difference with valuation allowance analysis',        tileStatus: 'outstanding', rowStatus: 'fulfilled',  attachmentLabel: 'Firm provided 5 files', meta: [{ type: 'due-date', date: '04/22/2025' }, { type: 'documents', count: 16 }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
  ...
  { id: 'rv2', sectionId: 'revenue',  order: 67, title: 'Deferred Revenue Schedule',             description: 'Rollforward of contract liabilities by revenue stream at the end of the period',          tileStatus: 'outstanding', rowStatus: 'fulfilled',  attachmentLabel: 'Firm provided 3 files', meta: [{ type: 'due-date', date: '04/18/2025' }, { type: 'comments', count: 2 }, { type: 'documents', count: 26 }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
  ...
  { id: 'pr3', sectionId: 'payroll',  order: 75, title: 'Benefit Plan Audit Report',             description: 'Completed Form 5500 or independent benefit plan audit report for the plan year',          tileStatus: 'outstanding', rowStatus: 'fulfilled',  attachmentLabel: 'Firm provided 2 files', meta: [{ type: 'due-date', date: '04/25/2025' }, { type: 'documents', count: 19 }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
  ...
  { id: 'it2', sectionId: 'it',       order: 80, title: 'User Access Review — ERP',              description: 'Periodic user access certification and segregation of duties review for the primary ERP',  tileStatus: 'outstanding', rowStatus: 'fulfilled',  meta: [{ type: 'due-date', date: '04/18/2025' }, { type: 'comments', count: 1 }, { type: 'documents', count: 38 }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
  ...
  { id: 'lg2', sectionId: 'legal',    order: 85, title: 'Litigation Summary',                   description: 'Management summary of all pending or threatened legal proceedings and expected exposure',    tileStatus: 'overdue',     rowStatus: 'returned',   isFlagged: true, meta: [{ type: 'due-date', date: '04/05/2025' }, { type: 'comments', count: 5 }, { type: 'documents', count: 9 }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
  ...
  // ─── Accrued Expenses ────────────────────────────────────────────────────
  { id: 'ac1', sectionId: 'accrued',  order: 93, title: 'Accrued Expenses Rollforward',         description: 'Beginning to ending rollforward of all significant accrued liabilities by category',        tileStatus: 'outstanding', rowStatus: 'fulfilled',  attachmentLabel: 'Firm provided 4 files', meta: [{ type: 'due-date', date: '04/18/2025' }, { type: 'comments', count: 1 }, { type: 'documents', count: 23 }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
  ...
  { id: 'ac5', sectionId: 'accrued',  order: 97, title: 'Customer Deposits Listing',            description: 'Detail of advance payments and customer deposits received and held at period end',           tileStatus: 'fulfilled',   rowStatus: 'accepted',   meta: [{ type: 'due-date', date: '04/08/2025' }, { type: 'documents', count: 23 }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
  ...
  { id: 'ls2', sectionId: 'leases',   order: 99,  title: 'ROU Asset & Lease Liability Schedule', description: 'Amortization table and rollforward of right-of-use assets and corresponding lease liabilities', tileStatus: 'outstanding', rowStatus: 'fulfilled', attachmentLabel: 'Firm provided 3 files', meta: [{ type: 'due-date', date: '04/22/2025' }, { type: 'documents', count: 29 }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
  ...
  { id: 'ins4', sectionId: 'insurance', order: 115, title: 'Workers Compensation Policy',        description: 'Workers compensation policy documentation and current experience modification rate factor',  tileStatus: 'outstanding', rowStatus: 'fulfilled',  attachmentLabel: 'Firm provided 2 files', meta: [{ type: 'due-date', date: '04/25/2025' }, { type: 'documents', count: 24 }, { type: 'assignee', initials: 'GS', color: 'var(--color-status-purple-surface)', textColor: 'var(--color-status-purple-fg)' }] },
...
const FILTER_SWATCHES = [
  { key: 'not-started', color: 'var(--color-swatch-not-started)', label: 'Outstanding' },
  { key: 'outstanding', color: 'var(--color-swatch-outstanding)',  label: 'Fulfilled'   },
  { key: 'fulfilled',   color: 'var(--color-swatch-fulfilled)',    label: 'Accepted'    },
  { key: 'overdue',     color: 'var(--color-swatch-overdue)',      label: 'Returned'    },
];
  ...
  const right = (
    <div className="flex items-center gap-4">
      <FilterSwatchGroup
        ...
        labelPosition="left"
        size="sm"
        swatches={FILTER_SWATCHES.map(({ key, color, label }) => ({
          color,
          label,
      ...
      <div className="flex items-center gap-1">
        <Tooltip content="Filter by assignee">
          ...
          >
            <Avatar size="xs" initials="A" variant="firm" />
          </button>
        </Tooltip>
        <Tooltip content="Filter by priority">
          ...
          >
            <span className="flex h-6 w-6 items-center justify-center rounded-pill bg-status-purple-surface text-status-purple-fg">
              <Flag02Icon size={14} />
            </span>
          </button>
        </Tooltip>
      ...
      <Dropdown
        ...
        trigger={
          <Button
            variant="secondary"
            size="xs"
            endIcon={<ChevronDownIcon size="sm" className={`text-muted transition-transform ${sortOpen ? 'rotate-180' : ''}`} />}
          >
            {sortValue}
          </Button>
        }
...
const meta: Meta = {
  title: 'RLM Layout/EngagementLayout',
...
// ─── Matrix — mirrors Figma "EngagementLayout" page (76:33) ──────────────────
// The page contains a single `State=Default` COMPONENT (1569:2) at 1440×900,
// composing the full TopNav → EngagementHeader → RequestStatusColorNav →
// ListToolbar (sticky) → MasterDetailLayout (Accordion+RequestRow list |
// RequestDetail panel) stack. Each sub-piece is verified individually by its
// own Matrix story; this Matrix locks in the assembled page at 1440×900.
const EL_CELLS: MatrixCellSpec[] = [
  {
    variant: 'EngagementLayout (State=Default)',
    x: 0,
    y: 0,
    w: 1440,
    h: 900,
    expect: {
      // EngagementHeader renders the engagementName as an <h1>. The selected
      // request title in the RequestDetail panel renders as an <h2>.
      headings: ['FY2025 Financial Statement Audit', 'CFO Initial Inquiries'],
    },
  },
];
